...
These are extremely basic examples of the algorithms you can implement with arrays in python
...
#linear search
def linear_search(sequence_b, x): 
...
sequence_b = [3,4,5,4,8,9]
x = 8
print(linear_search(sequence_b, x))
```
